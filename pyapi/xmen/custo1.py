...
def marvelcharcall(stampystamp, hashyhash, pkeyz, lookmeup):
    ...
    print(XAVIER+"?nameStartsWith="+lookmeup+"&ts="+stampystamp+"&apikey="+pkeyz+"&hash="+hashyhash)
    return r.json()
...
def main():           
    ...
    uncannyxmen = marvelcharcall(nightcrawler, cerebro, storm, args.nametobeginwith)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--nametobeginwith', \
